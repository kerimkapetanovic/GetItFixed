...
from django.utils import timezone  # OVO TI TREBA
...
class Booking(models.Model):
    ...
    def save(self, *args, **kwargs):
        # 1. Logika za Ticket ID (tvoj postojeći kod)
        ...
        # 2. NOVA LOGIKA ZA EXPIRES_AT:
        # Ako je booking tek kreiran (nema ID), postavi rok na 3 sata
