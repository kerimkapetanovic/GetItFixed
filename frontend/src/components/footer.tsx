...
export default function Footer() {
    return (
<footer className="border-t-2 border-black bg-white w-full py-12 px-6 mt-auto font-sans uppercase tracking-tight">            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
                
                {/* 1. SECTION: LOGO & DESCRIPTION */}
                <div className="flex flex-col gap-4">
                    <div className="flex items-center gap-2">
                        <span className="text-xl font-black tracking-tighter normal-case">GetItFixed</span>
                    </div>
                    ...
                    <div className="flex gap-4 mt-2">
                        <Link href="#" className="hover:text-gray-500 transition-colors"><FaFacebookF size={18} /></Link>
                        <Link href="#" className="hover:text-gray-500 transition-colors"><FaInstagram size={18} /></Link>
                    </div>
                </div>

                {/* 2. SECTION: FOR USERS */}
                <div>
                    <h4 className="font-black text-sm uppercase mb-6 tracking-widest">For Clients</h4>
                    <ul className="flex flex-col gap-3 text-sm font-bold text-gray-500 uppercase">
                        ...
                        <li><Link href="/stories" className="hover:text-black">Success Stories</Link></li>
                ...
                {/* 4. SECTION: CONTACT */}
                <div>
                    <h4 className="font-black text-sm uppercase mb-6 tracking-widest">Contact</h4>
            ...
            <div className="max-w-7xl mx-auto mt-12 pt-8 border-t border-gray-100">
                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest text-center md:text-left">
                    © 2026 GetItFixed. All rights reserved. Graduation project by Kerim Kapetanović, Amar Dizdarević, Faris Balić and Haris Šuta.
                </p>
            </div>
        </footer>
    );
