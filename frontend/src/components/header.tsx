                        ...
                        <div className="relative">
                            ...
                            >
                                <div className="text-right">
                                    ...
                                    <p className="text-[8px] font-bold text-gray-400 mt-1 uppercase leading-none tracking-tighter">Settings</p>
                                </div>
                                {/* AVATAR BOX - ROUNDED */}
                            ...
                            {isMenuOpen && (
                                ...
                                <div className="absolute right-0 mt-3 w-52 bg-white border-2 border-black z-50 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] rounded-[20px] overflow-hidden">
                                    <ul className="flex flex-col text-sm font-bold">
                                        <li className="p-4 border-b-2 border-black hover:bg-gray-50 cursor-pointer transition-colors">Account Settings</li>
                                        {userRole === 'admin' && (
                                            <li className="p-4 border-b-2 border-black hover:bg-gray-50 cursor-pointer text-red-600 transition-colors">System Logs</li>
                                        )}
                                        <li 
