...
function PremiumButton({ href, text, icon: Icon, isExternal = false }: PremiumButtonProps) {
  return (
    <Link
      ...
      className="flex items-center gap-6 bg-white dark:bg-zinc-900 border-[3px] border-black px-10 py-5 font-black uppercase text-xs tracking-[0.2em] text-gray-900 dark:text-zinc-100 shadow-[8px_8px_0px_0px_#000] hover:shadow-none hover:translate-x-1 hover:translate-y-1 hover:bg-[#EF9D39] dark:hover:bg-[#EF9D39] transition-all group"
    >
      <span className="group-hover:text-black">{text}</span>
  ...
  return (
    <div className="page-gradient flex flex-col min-h-screen text-black dark:text-white selection:bg-black selection:text-white font-sans">
      ...
      <main className="flex-grow">
        ...
        <section className="max-w-7xl mx-auto px-6 py-16 md:py-24">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8 text-center lg:text-left">
              ...
              <p className="text-lg font-bold text-gray-500 dark:text-zinc-400 max-w-lg leading-relaxed italic  mx-auto lg:mx-0">
            ...
            <div className="relative hidden lg:block">
              ...
              <div className="relative bg-white/70 dark:bg-zinc-900/80 backdrop-blur-xl border-[3px] border-black p-8 text-gray-900 dark:text-zinc-100 shadow-[15px_15px_0px_0px_#000]" style={{ borderRadius: "40px" }}>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={i} className="flex items-center justify-between bg-white dark:bg-zinc-800 border-2 border-black p-4 text-gray-900 dark:text-zinc-100 shadow-[4px_4px_0px_0px_rgba(0,0,0,0.1)]" style={{ borderRadius: "20px" }}>
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] font-bold text-gray-500 dark:text-zinc-400">{item.name}</p>
                        </div>
                      </div>
                      <span className="text-[10px] font-black uppercase bg-gray-100 dark:bg-zinc-700 text-gray-900 dark:text-zinc-100 px-3 py-1 rounded-full">{item.status}</span>
                    </div>
                  ))}
                </div>
              </div>
        ...
        <section className="max-w-7xl mx-auto px-6 pb-24 text-center md:text-left">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="group border-[3px] border-black p-8 bg-white dark:bg-zinc-900 text-gray-900 dark:text-zinc-100 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all" style={{ borderRadius: "25px" }}>
                ...
                <p className="text-xs font-bold text-gray-500 dark:text-zinc-400 leading-relaxed">{badge.desc}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        {/* 3. POPULAR SERVICES */}
        <section className="bg-white dark:bg-zinc-900 border-y-[3px] border-black dark:border-zinc-700 py-24 px-6 text-gray-900 dark:text-zinc-100">
          <div className="max-w-7xl mx-auto">
            <div className="mb-12">
              <h2 className="text-4xl font-black uppercase tracking-tighter italic">{t('home.popularServices')}</h2>
              <p className="font-bold text-gray-500 dark:text-zinc-400 uppercase text-xs mt-2 tracking-widest">{t('home.mostRequested')}</p>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
              {[
                ...
                <Link 
                  ...
                  className="group block cursor-pointer border-[3px] border-black p-8 bg-[#FDFBF9] dark:bg-zinc-800 text-gray-900 dark:text-zinc-100 shadow-[5px_5px_0px_0px_rgba(0,0,0,1)] hover:shadow-none hover:translate-x-[5px] hover:translate-y-[5px] transition-all text-center"
                >
        ...
        <section className="max-w-7xl mx-auto px-6 py-24 text-center">
          ...
          <p className="font-bold text-gray-500 dark:text-zinc-400 uppercase text-xs mb-16 tracking-widest">{t('home.threeSteps')}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-20">
            {[
              ...
              <div key={i} style={{ borderRadius: "30px" }} className="group flex flex-col items-center p-10 border-[3px] border-black bg-white dark:bg-zinc-900 text-gray-900 dark:text-zinc-100 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:shadow-[8px_8px_0px_0px_rgba(239,157,57,0.2)] transition-all hover:bg-[#FDFBF9] dark:hover:bg-zinc-800">
                ...
                <span className="font-black text-[10px] uppercase mb-2 text-gray-500 dark:text-zinc-400 tracking-[0.3em]">{t('home.stepLabel')} {item.step}</span>
                <h4 className="font-black uppercase text-xl mb-3 tracking-tight italic">{item.title}</h4>
                <p className="text-sm font-bold text-gray-500 dark:text-zinc-400 normal-case leading-relaxed">{item.desc}</p>
              </div>
            ))}
          </div>
