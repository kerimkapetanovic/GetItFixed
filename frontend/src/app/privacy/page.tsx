        ...
        <div className="page-gradient flex flex-col min-h-screen font-sans text-black dark:text-white">
            ...
            <main className="flex-grow max-w-5xl mx-auto px-6 py-12 w-full">
                ...
                <div className="relative mb-16 mt-6">
                    <div className="absolute inset-0 bg-black dark:bg-[#EF9D39]/20 translate-x-2 translate-y-2 rounded-[32px]" />
                    <div className="relative bg-white dark:bg-[#141414] border-[3px] border-black dark:border-[#222] p-10 text-center rounded-[32px]">
                        <h1 className="text-4xl md:text-5xl font-black uppercase tracking-tighter leading-none text-black dark:text-[#f0f0f0]">
                            PRIVACY <span style={{ color: brandColor }} className="italic">POLICY</span>
                        </h1>
                        <div className="mt-4 inline-block bg-black dark:bg-[#EF9D39] text-white dark:text-black px-5 py-2 font-black uppercase tracking-widest text-[10px]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {sections.map((section, idx) => (
                        <div key={idx} className="group relative">
                            ...
                            <div className="relative h-full bg-white dark:bg-[#141414] border-[3px] border-black dark:border-[#222] p-6 rounded-[24px] flex flex-col">
                                <span className="text-2xl font-black opacity-10 absolute right-5 top-4 text-black dark:text-white">0{idx + 1}</span>
                                <h2 className="text-lg font-black uppercase mb-3 pr-8 leading-tight text-black dark:text-[#f0f0f0]">
                                    {section.title}
                                </h2>
                                
                                {section.content && (
                                    <p className="text-[13px] leading-relaxed font-medium text-gray-600 dark:text-[#888] flex-grow">
                                        {section.content}
                                    </p>
                                )}
                                ...
                                {section.list && (
                                    <ul className="space-y-2.5 mt-1">
                                        {section.list.map((item, i) => (
                                            <li key={i} className="text-[12px] font-bold flex items-start text-gray-700 dark:text-[#aaa]">
                                                <span 
                ...
                <div className="mt-16 relative">
                    <div className="absolute inset-0 bg-black dark:bg-[#EF9D39]/20 translate-x-2 translate-y-2 rounded-[32px]" />
                    <div className="relative bg-white dark:bg-[#141414] border-[3px] border-black dark:border-[#222] p-8 rounded-[32px] flex flex-col md:flex-row justify-between items-center gap-6">
                        <div className="text-center md:text-left">
                            <h2 className="text-3xl font-black uppercase tracking-tight text-black dark:text-[#f0f0f0]">Need Clarity?</h2>
                            <p className="font-bold text-gray-400 dark:text-[#555] uppercase tracking-widest text-[10px] mt-1">
                        ...
                        <div className="flex flex-col items-center md:items-end gap-1">
                            <a 
                                ...
                                className="text-lg font-black decoration-4 transition-colors text-black dark:text-[#f0f0f0] hover:text-[#EF9D39] dark:hover:text-[#EF9D39]"
                            ...
                            <a 
                                ...
                                className="font-black text-base text-black dark:text-[#f0f0f0] hover:text-[#EF9D39] dark:hover:text-[#EF9D39]" 
                                style={{ textDecorationColor: brandColor }}
                            >
                                +387 61 123 456
                            </a>
