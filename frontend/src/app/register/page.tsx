...
export default function RegisterPage() {
  ...
  useEffect(() => {
    const newRole =
      searchParams?.get("role") === "handyman" ? "handyman" : "client";
    setRole(newRole);
  }, [searchParams]);
  ...
  const submitRegistration = async () => {
    ...
    try {
      ...
      alert(
        `${t("register.errorPrefix")} ${JSON.stringify(apiError.response?.data || t("register.genericError"))}`,
      );
      return false;
    } finally {
      setLoading(false);
      ...
      <main className="flex-grow flex items-center justify-center p-6 py-12">
        ...
        >
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="group">
                ...
                <input
                  ...
                  className="w-full bg-white dark:bg-zinc-800 border-2 border-black dark:border-zinc-600 p-4 text-sm font-bold text-gray-900 dark:text-white outline-none focus:bg-yellow-50 dark:focus:bg-zinc-700 transition-all placeholder:text-gray-400 dark:placeholder:text-zinc-500"
                />
              </div>
              <div className="group">
                <label className="block text-xs font-black text-gray-900 dark:text-zinc-300 uppercase tracking-widest mb-2 ml-1">
            ...
            {role === "handyman" && (
              <div
                className="p-6 border-4 border-black dark:border-zinc-600 bg-gray-50 dark:bg-zinc-800 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]"
                  ...
                  <div className="relative">
                    ...
                    >
                      <option value="" disabled className="text-gray-400">
                        {t("register.expertisePlaceholder")}
                      </option>
                      {serviceOptions.map((service) => (
                        <option key={service} value={service}>
                          {t(`register.services.${service}`)}
                        </option>
                      ))}
                    </select>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              <div className="group">
                <label className="block text-xs font-black text-gray-900 dark:text-zinc-300 uppercase tracking-widest mb-2 ml-1 flex items-center gap-2">
                  <Globe size={12} /> {t("register.country")}
                </label>
                <div className="relative">
                  <select
                    required
              ...
              <div className="group">
                <label className="block text-xs font-black text-gray-900 dark:text-zinc-300 uppercase tracking-widest mb-2 ml-1 flex items-center gap-2">
                  <MapPin size={12} /> {t("register.city")}
                </label>
                <input
                  type="text"
                  ...
                  className="w-full bg-white dark:bg-zinc-800 border-2 border-black dark:border-zinc-600 p-4 text-sm font-bold text-gray-900 dark:text-white outline-none placeholder:text-gray-400 dark:placeholder:text-zinc-500"
                />
              </div>
              <div className="group">
                <label className="block text-xs font-black text-gray-900 dark:text-zinc-300 uppercase tracking-widest mb-2 ml-1 flex items-center gap-2">
                  <Hash size={12} /> {t("register.zipCode")}
                </label>
                <input
                  type="text"
            ...
            <div className="group">
              <label className="block text-xs font-black text-gray-900 dark:text-zinc-300 uppercase tracking-widest mb-2 ml-1 flex items-center gap-2">
                <Lock size={12} /> {t("register.createPassword")}
              </label>
              <div className="relative flex flex-col w-full">
                <div className="relative flex items-center">
                  ...
                  <button
                    ...
                    className="absolute right-4 text-gray-700 dark:text-zinc-300 z-30"
                  >
            ...
            <button
              ...
              type="submit"
              style={inputRadius}
              className="cursor-pointer w-full mt-6 mb-4 bg-black text-white py-5 font-black uppercase tracking-widest text-sm transition-all border-2 border-black shadow-[6px_6px_0px_0px_rgba(249,177,77,1)] hover:shadow-none hover:translate-x-1 hover:translate-y-1 active:scale-95 disabled:opacity-50"
            >
              {loading
          ...
          <div className="mt-8 text-center">
            ...
            >
              ...
              <span className="text-gray-900 dark:text-zinc-100 border-b-2 border-yellow-300 pb-0.5 hover:bg-yellow-300 transition-colors">
