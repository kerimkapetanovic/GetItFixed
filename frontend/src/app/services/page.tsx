...
import {
  ...
  Wind, Monitor, Home, Lock, Sofa, Layout
} from "lucide-react";
...
export default function Services() {
  ...
  const serviceCategories = [
    ...
    { id: "pools", name: "Pool Services", icon: <Waves size={24} />, color: "bg-cyan-100", desc: "Cleaning & equipment maintenance." }, // Zamijenjeno sa Waves
    { id: "carpenter", name: "Carpenter", icon: <Hammer size={24} />, color: "bg-orange-100", desc: "Custom woodwork & furniture repair." },
    { id: "tiler", name: "Ceramics & Tiling", icon: <LayoutGrid size={24} />, color: "bg-stone-100", desc: "Floor & wall tile installation." }, // Zamijenjeno sa LayoutGrid
    { id: "cleaning", name: "Cleaning", icon: <Trash2 size={24} />, color: "bg-sky-100", desc: "Professional home & office cleaning." },
    { id: "excavation", name: "Excavation", icon: <Pickaxe size={24} />, color: "bg-amber-200", desc: "Groundwork & heavy machinery." }, // Zamijenjeno sa Pickaxe
  ...
  // Ostatak koda (return dio) ostaje isti kao u prethodnoj poruci...
  return (
      ...
      <main className="flex-grow max-w-6xl mx-auto px-6 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-black uppercase tracking-tighter mb-2">
            Our <span className="text-[#EF9D39]">Services</span>
          </h1>
          ...
          {serviceCategories.map((service) => (
            ...
            >
              ...
              <Link
                ...
                className="flex items-center justify-center gap-2 bg-black text-white px-4 py-2 text-[10px] font-black uppercase tracking-widest hover:bg-yellow-300 hover:text-black transition-all border-2 border-black w-full"
              >
